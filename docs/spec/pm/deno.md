...
> Updated: 2026-07-27.
> Family: **non-Node** — the single most divergent entry in `docs/spec/pm/`. Deno is a
...
TypeScript-first registry. Cross-reference [`docs/spec/registry/jsr.md`](../registry/jsr.md)
...
(default `registry.npmjs.org`; cross-ref [`docs/spec/registry/npm.md`](../registry/npm.md)
...
- This is the layout most legible to this project's existing Node-family layout
  model (`docs/spec/04-layouts.md`): when Deno *does* build `node_modules`, it is
...
`docs/spec/registry/` entry:

| Source | Protocol | Integrity | Registry spec |
|---|---|---|---|
| `npm:` specifiers | npm registry protocol (default `registry.npmjs.org`) | sha512 SRI (`dist.integrity`) | [`docs/spec/registry/npm.md`](../registry/npm.md) + [`_common.md`](../registry/_common.md) |
| `jsr:` specifiers | **native JSR** (`jsr.io`), source + meta API | package metadata lock checksum; per-file hashes inside metadata | [`docs/spec/registry/jsr.md`](../registry/jsr.md) (consult the **native** face, not `npm.jsr.io`) |
...
- Default npm registry is overridable (`.npmrc`/`NPM_CONFIG_REGISTRY` are honoured
  in npm-compat) — so the full `docs/spec/registry/` matrix (verdaccio, nexus,
